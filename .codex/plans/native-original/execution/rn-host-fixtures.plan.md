...
overview: "Prepare real Claude and Codex Native comparison journeys. Preserve the complete original b3 Native implementation and its operation boundaries."
todos:
...
4. Remove expectations that successful Native means returning four staged messages. Derive expected fact/session/context behavior from the b3 reference and matching host action.
