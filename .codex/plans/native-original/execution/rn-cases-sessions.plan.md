...
overview: "Author original session and LCM comparison cases. Preserve the complete original upstream Native implementation from 570 and its operation boundaries."
todos:
...
Mode: write-capable.
Prerequisites: rn-reference, rn-contract, rn-history-owner-followup. Every named predecessor must be accepted by root before dependent work starts. Original baseline: 57006f60cb45bcee8487e73a40d4fad1a12ee2b6; audited product head: 1fe250fed7ca615f1dfdcd580befeb276328e910.
...
Prerequisites: rn-reference, rn-contract, rn-history-owner-followup. The exact edges in ../execution-selection.json are authoritative; this section supersedes older prerequisite prose. Read ../READINESS-PLAN.md for the latest NCM repair and semantic scope.
