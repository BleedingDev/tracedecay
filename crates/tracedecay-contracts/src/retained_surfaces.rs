...
-> Result<CatalogContributionV1, ApplicationContractError> {
    ...
    let contribution = CatalogContributionV1::new(CatalogContributionInputV1::new(
        ContributionId::new("contribution.application.retained-memory-session-workflow")?,
        Vec::new(),
        capabilities,
        bindings,
    ))?;
...
fn retained_surface_executable_schemas(
    ...
    Ok(vec![
        ...
        retained_surface_executable_schema::<FactStoreAddRequestV1, FactStoreAddResultV1>(
            ...
            "tracedecay_contracts::retained_surfaces::FactStoreAddRequestV1",
            "tracedecay_contracts::retained_surfaces::FactStoreAddResultV1",
        )?,
        retained_surface_executable_schema::<FactStoreSearchRequestV1, FactStoreSearchResultV1>(
            ...
            "tracedecay_contracts::retained_surfaces::FactStoreSearchRequestV1",
            "tracedecay_contracts::retained_surfaces::FactStoreSearchResultV1",
        )?,
        retained_surface_executable_schema::<FactStoreProbeRequestV1, FactStoreProbeResultV1>(
            contribution,
            RetainedSurfaceOperation::FactStoreProbe,
            "tracedecay_contracts::retained_surfaces::FactStoreProbeRequestV1",
            "tracedecay_contracts::retained_surfaces::FactStoreProbeResultV1",
        )?,
        retained_surface_executable_schema::<FactStoreRelatedRequestV1, FactStoreRelatedResultV1>(
            ...
            "tracedecay_contracts::retained_surfaces::FactStoreRelatedRequestV1",
            "tracedecay_contracts::retained_surfaces::FactStoreRelatedResultV1",
        )?,
        retained_surface_executable_schema::<FactStoreReasonRequestV1, FactStoreReasonResultV1>(
            ...
            "tracedecay_contracts::retained_surfaces::FactStoreReasonRequestV1",
            "tracedecay_contracts::retained_surfaces::FactStoreReasonResultV1",
        )?,
        ...
        >(
            ...
            "tracedecay_contracts::retained_surfaces::FactStoreContradictRequestV1",
            "tracedecay_contracts::retained_surfaces::FactStoreContradictResultV1",
        )?,
        retained_surface_executable_schema::<FactStoreGetRequestV1, FactStoreGetResultV1>(
            contribution,
            RetainedSurfaceOperation::FactStoreGet,
            "tracedecay_contracts::retained_surfaces::FactStoreGetRequestV1",
            "tracedecay_contracts::retained_surfaces::FactStoreGetResultV1",
        )?,
        retained_surface_executable_schema::<FactStoreUpdateRequestV1, FactStoreUpdateResultV1>(
            ...
            "tracedecay_contracts::retained_surfaces::FactStoreUpdateRequestV1",
            "tracedecay_contracts::retained_surfaces::FactStoreUpdateResultV1",
        )?,
        retained_surface_executable_schema::<FactStoreRemoveRequestV1, FactStoreRemoveResultV1>(
            ...
            "tracedecay_contracts::retained_surfaces::FactStoreRemoveRequestV1",
            "tracedecay_contracts::retained_surfaces::FactStoreRemoveResultV1",
        )?,
        retained_surface_executable_schema::<
        ...
        >(
            ...
            "tracedecay_contracts::retained_surfaces::FactStoreSupersedeRequestV1",
            "tracedecay_contracts::retained_surfaces::FactStoreSupersedeResultV1",
        )?,
        retained_surface_executable_schema::<FactStoreListRequestV1, FactStoreListResultV1>(
            contribution,
            RetainedSurfaceOperation::FactStoreList,
            "tracedecay_contracts::retained_surfaces::FactStoreListRequestV1",
            "tracedecay_contracts::retained_surfaces::FactStoreListResultV1",
        )?,
        retained_surface_executable_schema::<FactFeedbackRequestV1, FactFeedbackResultV1>(
            contribution,
            RetainedSurfaceOperation::FactFeedback,
            "tracedecay_contracts::retained_surfaces::FactFeedbackRequestV1",
        ...
        retained_surface_executable_schema::<MemoryStatusRequestV1, MemoryStatusResultV1>(
            ...
            "tracedecay_contracts::retained_surfaces::MemoryStatusResultV1",
        )?,
        retained_surface_executable_schema::<
        ...
        >(
            ...
            "tracedecay_contracts::retained_surfaces::SessionRefreshActionRequestV1",
            "tracedecay_contracts::retained_surfaces::SessionRefreshStatusResultV1",
        )?,
        retained_surface_executable_schema::<
            SessionRefreshActionRequestV1,
        ...
        >(
            ...
            "tracedecay_contracts::retained_surfaces::SessionRefreshActionRequestV1",
            "tracedecay_contracts::retained_surfaces::SessionRefreshCancelResultV1",
        )?,
        retained_surface_executable_schema::<
            SessionRefreshActionRequestV1,
        ...
        >(
            ...
            "tracedecay_contracts::retained_surfaces::SessionRefreshActionRequestV1",
            "tracedecay_contracts::retained_surfaces::SessionRefreshBeginResultV1",
        )?,
        retained_surface_executable_schema::<MessageSearchRequestV1, MessageSearchResultV1>(
            contribution,
            RetainedSurfaceOperation::MessageSearch,
            "tracedecay_contracts::retained_surfaces::MessageSearchRequestV1",
            "tracedecay_contracts::retained_surfaces::MessageSearchResultV1",
        )?,
        retained_surface_executable_schema::<SessionsForRequestV1, SessionsForResultV1>(
            contribution,
            RetainedSurfaceOperation::SessionsFor,
            "tracedecay_contracts::retained_surfaces::SessionsForRequestV1",
            "tracedecay_contracts::retained_surfaces::SessionsForResultV1",
        )?,
        retained_surface_executable_schema::<LcmStatusRequestV1, LcmStatusResultV1>(
            contribution,
            RetainedSurfaceOperation::LcmStatus,
            "tracedecay_contracts::retained_surfaces::LcmStatusRequestV1",
            "tracedecay_contracts::retained_surfaces::LcmStatusResultV1",
        )?,
        retained_surface_executable_schema::<LcmDoctorRequestV1, LcmDoctorResultV1>(
            contribution,
            RetainedSurfaceOperation::LcmDoctor,
            "tracedecay_contracts::retained_surfaces::LcmDoctorRequestV1",
            "tracedecay_contracts::retained_surfaces::LcmDoctorResultV1",
        )?,
        retained_surface_executable_schema::<LcmLoadSessionRequestV1, LcmLoadSessionResultV1>(
            contribution,
            RetainedSurfaceOperation::LcmLoadSession,
            "tracedecay_contracts::retained_surfaces::LcmLoadSessionRequestV1",
            "tracedecay_contracts::retained_surfaces::LcmLoadSessionResultV1",
        )?,
        retained_surface_executable_schema::<LcmGrepRequestV1, LcmGrepResultV1>(
            contribution,
            RetainedSurfaceOperation::LcmGrep,
            "tracedecay_contracts::retained_surfaces::LcmGrepRequestV1",
            "tracedecay_contracts::retained_surfaces::LcmGrepResultV1",
        )?,
        retained_surface_executable_schema::<LcmDescribeRequestV1, LcmDescribeResultV1>(
            contribution,
            RetainedSurfaceOperation::LcmDescribe,
            "tracedecay_contracts::retained_surfaces::LcmDescribeRequestV1",
            "tracedecay_contracts::retained_surfaces::LcmDescribeResultV1",
        )?,
        retained_surface_executable_schema::<LcmExpandRequestV1, LcmExpandResultV1>(
            contribution,
            RetainedSurfaceOperation::LcmExpand,
            "tracedecay_contracts::retained_surfaces::LcmExpandRequestV1",
            "tracedecay_contracts::retained_surfaces::LcmExpandResultV1",
        )?,
        retained_surface_executable_schema::<LcmExpandQueryRequestV1, LcmExpandQueryResultV1>(
            contribution,
            RetainedSurfaceOperation::LcmExpandQuery,
            "tracedecay_contracts::retained_surfaces::LcmExpandQueryRequestV1",
            "tracedecay_contracts::retained_surfaces::LcmExpandQueryResultV1",
        )?,
