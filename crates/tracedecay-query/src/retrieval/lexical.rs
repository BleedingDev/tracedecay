...
pub use self::projection::{
    ...
    CODE_LEXICAL_ARTIFACT_QUERY_CACHE_BUDGET_BYTES_V1, AuthenticatedCloneArtifactPageV1,
    ...
    CloneFingerprintDiscoveryPositionV2, CloneNearMatchExtentV1,
    CloneSelectedBlockArtifactCandidateV1,
    CloneSelectedBlockArtifactReadV1, CloneSelectedBlockContainmentClassV1, CloneSelectedBlockV1,
    CloneFamilyCursorPositionV2, CloneFamilyCursorV2,
    CloneSuccessorReuseAccountingV1, CodeExactLexicalArtifactReaderV1,
