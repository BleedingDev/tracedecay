...
/// incompatible branch-local development artifact and refuses admission with
/// [`ResetRequired`](tracedecay_domain::errors::TraceDecayError::ResetRequired)
/// instead of migrating. The nullable live-origin evidence column is an
/// additive exception: old rows keep their unknown origin without rewriting
/// their canonical observation or repository capture.
