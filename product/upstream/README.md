...
descendant of F, the train that accepts it runs with `prepare --transplant`,
which records the abandoned floor and the merge base under
`floor_transplant` in the train state.
