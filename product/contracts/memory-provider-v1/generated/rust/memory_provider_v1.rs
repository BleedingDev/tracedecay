...
// generator-sha256: 12501dc6d3c2222acb157cd1a0cb465b3958c5e5a2fa630d0b7eeb812448d367
...
pub const CONTRACTS: &[ContractSpec] = &[
    ContractSpec {
        ...
        bead_id: "tdmem-0201",
        contract_sha256: "54197322d563ccc21ad919cbf29028b52c1771e735d9959cd9196f2298db9bd2",
        schema_sha256: "5d47d0cc405def59273164d902fd4b85fc6b886479d152703760689233719733",
    },
    ContractSpec {
    ...
    ContractSpec {
        ...
        bead_id: "tdmem-0203",
        contract_sha256: "a8d078f227791cf3304de48e03e354377aab24e33a0588f3cd28364c4e303063",
        schema_sha256: "5f73ece2cc1f4954885a97812db81afdeb303822d9865af2a5be4d89d6952e91",
    },
    ContractSpec {
        contract_id: "tracedecay.memory.provider.recall.v1",
        bead_id: "tdmem-0204",
        contract_sha256: "0ffd01a21e599d6378bfa568126f87206892b9d5a68d3ff0de111238d981befa",
        schema_sha256: "210a6791014c9545af645720ce49075a5cc7b693a08fd734a4049c775b322daa",
    },
    ContractSpec {
        contract_id: "tracedecay.memory.provider.lifecycle.v1",
        bead_id: "tdmem-0205",
        contract_sha256: "31bc7f1320229de58e92b5040f3fa0e053a13c954b3b8c585ea10b907a2b4e4c",
        schema_sha256: "34306254f9110365535aecbd7cbbc9fc402899d96d895afb26da62d92f3de219",
    },
    ContractSpec {
...
pub const CAPABILITIES: &[CapabilitySpec] = &[
    ...
    CapabilitySpec {
        capability_id: "memory.advisory_common.v1",
        requirement: CapabilityRequirement::Optional,
        behavior_class: "None",
        detailed_contract_bead: "tdmem-0201",
        advisory_only: true,
        may_mutate_tracedecay_authority: false,
    },
];
...
pub const COMMON_ADVISORY_PROFILE_ID: &str = "memory.advisory_common.v1";

/// Canonical common advisory profile declaration.
pub const COMMON_ADVISORY_REQUIRED_CAPABILITIES: &[&str] = &[
    "provider.health.v1",
...
/// Canonical common advisory profile declaration.
pub const COMMON_ADVISORY_OBSERVATION_KINDS: &[&str] = &[
...
/// Canonical common advisory profile declaration.
pub const COMMON_ADVISORY_OPTIONAL_CAPABILITIES: &[&str] = &[
...
/// Canonical common advisory profile declaration.
pub const COMMON_ADVISORY_OPTIONAL_OBSERVATION_KINDS: &[&str] = &[
...
/// Closed wire values for `UnknownValidityPolicy`.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
...
/// Closed wire values for `SourceDisposition`.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub enum SourceDisposition {
    /// Wire value `available`.
    Available,
    /// Wire value `superseded`.
    Superseded,
    /// Wire value `revoked`.
    Revoked,
    /// Wire value `deleted`.
...
/// Closed wire values for `HistoryRelation`.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub enum HistoryRelation {
    /// Wire value `exact_scope`.
    ExactScope,
    /// Wire value `same_checkout`.
    SameCheckout,
}
...
impl HistoryRelation {
    ...
    pub const fn as_wire(self) -> &'static str {
        match self {
            Self::ExactScope => "exact_scope",
            Self::SameCheckout => "same_checkout",
        }
    }
    ...
    pub fn from_wire(value: &str) -> Option<Self> {
        match value {
            "exact_scope" => Some(Self::ExactScope),
            "same_checkout" => Some(Self::SameCheckout),
            _ => None,
        }
    }
}

/// Closed wire values for `FeedbackSignal`.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
...
/// Closed wire values for `MaintenanceTask`.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub enum MaintenanceTask {
    /// Wire value `consolidate`.
    Consolidate,
    /// Wire value `decay`.
    Decay,
    /// Wire value `prune_expired`.
    PruneExpired,
    /// Wire value `validate_state`.
    ValidateState,
    /// Wire value `repair`.
    Repair,
    /// Wire value `compact`.
...
/// Closed wire values for `InspectionView`.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub enum InspectionView {
    /// Wire value `state_summary`.
    StateSummary,
    /// Wire value `source_influence`.
    SourceInfluence,
    /// Wire value `trace`.
    Trace,
    /// Wire value `delivery_receipt`.
    DeliveryReceipt,
    /// Wire value `maintenance_receipt`.
    MaintenanceReceipt,
    /// Wire value `snapshot_metadata`.
    SnapshotMetadata,
    /// Wire value `capability_status`.
    CapabilityStatus,
}
...
impl InspectionView {
    ...
    pub fn from_wire(value: &str) -> Option<Self> {
        match value {
            "state_summary" => Some(Self::StateSummary),
            "source_influence" => Some(Self::SourceInfluence),
            "trace" => Some(Self::Trace),
            "delivery_receipt" => Some(Self::DeliveryReceipt),
            "maintenance_receipt" => Some(Self::MaintenanceReceipt),
            "snapshot_metadata" => Some(Self::SnapshotMetadata),
            "capability_status" => Some(Self::CapabilityStatus),
            _ => None,
        }
    }
}

/// Closed wire values for `CorrectionKind`.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub enum CorrectionKind {
    /// Wire value `supersede`.
    Supersede,
    /// Wire value `restrict_scope`.
    RestrictScope,
    /// Wire value `change_validity`.
    ChangeValidity,
    /// Wire value `replace_content`.
    ReplaceContent,
    /// Wire value `mark_incorrect`.
    MarkIncorrect,
}
...
impl CorrectionKind {
    ...
    pub const fn as_wire(self) -> &'static str {
        match self {
            ...
            Self::ChangeValidity => "change_validity",
            Self::ReplaceContent => "replace_content",
            Self::MarkIncorrect => "mark_incorrect",
        }
    }
    ...
    pub fn from_wire(value: &str) -> Option<Self> {
        match value {
            ...
            "restrict_scope" => Some(Self::RestrictScope),
            "change_validity" => Some(Self::ChangeValidity),
            "replace_content" => Some(Self::ReplaceContent),
            "mark_incorrect" => Some(Self::MarkIncorrect),
            _ => None,
        }
    }
}

/// Closed wire values for `DeletionMode`.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub enum DeletionMode {
    /// Wire value `remove_influence`.
    RemoveInfluence,
    /// Wire value `hard_delete`.
    HardDelete,
    /// Wire value `anonymize`.
    Anonymize,
}
...
impl DeletionMode {
    ...
    pub const fn as_wire(self) -> &'static str {
        match self {
            Self::RemoveInfluence => "remove_influence",
    ...
    pub fn from_wire(value: &str) -> Option<Self> {
        match value {
            "remove_influence" => Some(Self::RemoveInfluence),
            "hard_delete" => Some(Self::HardDelete),
...
/// Closed wire values for `ReplayItemState`.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub enum ReplayItemState {
    /// Wire value `applied`.
    Applied,
    /// Wire value `delivery_duplicate`.
    DeliveryDuplicate,
    /// Wire value `source_already_applied`.
...
impl ReplayItemState {
    ...
    pub const fn as_wire(self) -> &'static str {
        match self {
            ...
            Self::DeliveryDuplicate => "delivery_duplicate",
            Self::SourceAlreadyApplied => "source_already_applied",
    ...
    pub fn from_wire(value: &str) -> Option<Self> {
        match value {
            ...
            "delivery_duplicate" => Some(Self::DeliveryDuplicate),
            "source_already_applied" => Some(Self::SourceAlreadyApplied),
